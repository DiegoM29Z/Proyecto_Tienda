...
import CapaLogicaNegocio_Helpers.HelperRegistro;
import CapaLogicaNegocio_Helpers.HelperValidacion;
...
public class RegistrarPersonaAdministrador extends javax.swing.JFrame {
    ...
    public void RegistarProducto() {
        ...
        res = CapaLogicaNegocio_Helpers.HelperValidacion.ValidarTodo(nombre);
        res1 = CapaLogicaNegocio_Helpers.HelperValidacion.ValidarTodo(marca);
        res2 = CapaLogicaNegocio_Helpers.HelperValidacion.ValidarTodoSerial(serial);
    ...
    public void RegistrarPersona() {
        ...
        res = CapaLogicaNegocio_Helpers.HelperValidacion.ValidarTodo(nombre);
        res1 = CapaLogicaNegocio_Helpers.HelperValidacion.ValidarTodo(apellido);
        res2 = CapaLogicaNegocio_Helpers.HelperValidacion.ValidarTodoLetra(cedula);
        res3 =  CapaLogicaNegocio_Helpers.HelperValidacion.ValidarTodoDireccion(direccion);
        res4 = CapaLogicaNegocio_Helpers.HelperValidacion.ValidarTodoSerial(nom_img);
